...
class MoreCell: UITableViewCell
{
    ...
    func populateItem(event: [String])
    {
        ...
        } else if event[0] == "Results"
        {
            ...
            imageView1 = UIImageView(image: UIImage(named: "Link")!)
            imageView1.frame = CGRect(x: 0, y: 0, width: 50, height:50)
            itemButton.addSubview(imageView1)
            ...
            imageView1 = UIImageView(image: UIImage(named: "HUSOLogo3")!)
            imageView1.frame = CGRect(x: 0, y: -10, width: 55, height:55)
            itemButton.addSubview(imageView1)
            imageView1.center = CGPoint(x: itemButton.frame.size.width  / 2,
                                         y: itemButton.frame.size.height / 2)
            imageView1.center.y = imageView1.center.y+2
            ...
            imageView1 = UIImageView(image: UIImage(named: "Contact")!)
            imageView1.frame = CGRect(x: 0, y: 0, width: 45, height:45)
            itemButton.addSubview(imageView1)
            imageView1.center = CGPoint(x: itemButton.frame.size.width  / 2,
                                       y: itemButton.frame.size.height / 2)
            imageView1.center.x = imageView1.center.x-2
            ...
            imageView1 = UIImageView(image: UIImage(named: "Police")!)
            imageView1.frame = CGRect(x: 0, y: 0, width: 45, height:45)
            itemButton.addSubview(imageView1)
            imageView1.center = CGPoint(x: itemButton.frame.size.width  / 2,
                                       y: itemButton.frame.size.height / 2)
            ...
            imageView1 = UIImageView(image: UIImage(named: "Bug")!)
            imageView1.frame = CGRect(x: 0, y: 0, width: 52, height:52)
            itemButton.addSubview(imageView1)
            imageView1.center = CGPoint(x: itemButton.frame.size.width  / 2,
                                       y: itemButton.frame.size.height / 2)
            ...
            imageView1 = UIImageView(image: UIImage(named: "Test")!)
            imageView1.frame = CGRect(x: 0, y: 0, width: 52, height:52)
            itemButton.addSubview(imageView1)
            imageView1.center = CGPoint(x: itemButton.frame.size.width  / 2,
                                       y: itemButton.frame.size.height / 2)
